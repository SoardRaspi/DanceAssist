...
# if True:
#
def camera_input(eye_crop_window = 32):
    ...
    reward_avg = reward_avg / eye_crop_window
    ...
    return eye_right_cropped_model_input, eye_left_cropped_model_input, reward_avg

# out1, out2, out3 = camera_input()
...
# empty_frame = concat_images(out1)

# cv.imshow("empty", empty_frame)
# cv.waitKey(0)
# cv.destroyAllWindows()

# f, axarr = plt.subplots(2, 2)
# # axarr[0, 0].imshow(out1[0])
# # axarr[1, 0].imshow(out2[0])
# axarr[1, 1].imshow(empty_frame)

# # Optional for plotting concatenated imaegs:
# plt.imshow(empty_frame, cmap='gray')
# plt.colorbar()
# plt.show()


def camera_input_2():
    print("reached the camera_input_2 function")
    ...
    start_2 = time.time()
    start_3 = time.time()
    concat_frame_left = concat_images(out1)
    end_3 = time.time()

    start_4 = time.time()
    concat_frame_right = concat_images(out2)
    end_4 = time.time()
    end_2 = time.time()

    print("time for taking video input:", end_1 - start_1)
    ...
    return concat_frame_right, concat_frame_left, out3
