...
from model_v1 import MUSIC1, QTrainer
...
class Agent:
    ...
    def train_short_memory(self, state, action, reward, next_state):
        print("reached the train_short_memory in music_agent:", state, action, reward)
    ...
    def get_music(self, state):
        ...
        if random_decider < self.epsilon:
            random_note = np.random.random(10)
            ...
            state0 = state
            print("state0 in music_agent:", state0)
...
#
#         # get move
#         final_move = agent.get_music(state_old)
#
